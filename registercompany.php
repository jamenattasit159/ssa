...
<body>
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">ลงทะเบยีนโรงงาน / เอกชน</h2>
        </div>
        <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    <label for="company" class="block text-sm font-semibold leading-6 text-gray-900">ลงทะเบยีนโรงงาน / เอกชน</label>
                    <div class="mt-2.5">
                        <select class="select select-bordered w-full max-w-full">
                            <option disabled selected>Who shot first?</option>
                            <option>Han Solo</option>
